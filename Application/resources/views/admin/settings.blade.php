         ...
         <div class="tab-content">
            <div class="tab-pane active show" id="info">
               <form method="POST">
                  ...
                  <div class="row">
                     <div class="col-lg-4">
                        <div class="form-group">
                           <label for="max_filesize">{{__('Max file size :')}}<span class="fsgred">*</span></label>
                           <div class="input-group">
                            ...
                            <small class="text-muted">{{__('1073741824 Bytes = 1 Gigabytes')}}</small>
                        </div>
                     </div>
                     <div class="col-lg-4">
                        <div class="form-group">
                     ...
                     <div class="col-lg-4">
                        <div class="form-group">
                           <label for="waiting_time">{{__('Download waiting time (Limit 50 seconds) :')}}<span class="fsgred">*</span></label>
                           <input type="number" name="waiting_time" id="waiting_time" class="form-control" placeholder="0" required value="{{ $settings->waiting_time ?? "0" }}">
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-lg-6">
                        <div class="form-group">
                           <label for="addthis_code">{{__('AddThis Code :')}} <a href="https://addthis.com" target="_blank">{{__('Get code')}}</a></label>
                           <input type="text" name="addthis_code" id="addthis_code" placeholder="ra-123456789123" class="form-control" required value="{{ $settings->addthis_code}}">
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group">
                           <label for="disqus_url">{{__('Disqus URL :')}} <a href="https://disqus.com/admin/create/" target="_blank">{{__('Get URL')}}</a></label>
                           <input type="link" name="disqus_url" id="disqus_url" placeholder="https://[NAME].disqus.com/embed.js" class="form-control" required value="{{ $settings->disqus_url }}">
                        </div>
                     </div>
                     <hr class="mt-3"/>
                     <div class="col-lg-4">
                        <div class="form-group mb-4 row">
                           <label class="form-label col col-form-label">{{__('Primary color :')}} <span class="fsgred">*</span></label>
                           <div class="col">
                               <input type="color" name="color_1" id="color_1" class="form-control form-control-color" value="{{ $settings->color_1 ?? "" }}" title="Choose your color">
                           </div>
                       </div>
                     </div>
                     <div class="col-lg-4">
                        <div class="form-group mb-4 row">
                           <label class="form-label col col-form-label">{{__('Second color :')}} <span class="fsgred">*</span></label>
                           <div class="col">
                               <input type="color" name="color_2" id="color_2" class="form-control form-control-color" value="{{ $settings->color_2 ?? "" }}" title="Choose your color">
                           </div>
                       </div>
                     </div>
                     <div class="col-lg-4">
                        <div class="form-group mb-4 row">
                           <label class="form-label col col-form-label">{{__('Third color :')}} <span class="fsgred">*</span></label>
                           <div class="col">
                               <input type="color" name="color_3" id="color_3" class="form-control form-control-color" value="{{ $settings->color_3 ?? "" }}" title="Choose your color">
                           </div>
                       </div>
                     </div>
                  </div>
            ...
            <div class="tab-pane" id="ogofav">
               <form method="POST" enctype="multipart/form-data">
                  <div class="image bg-black text-white">
                     @if($settings != null)
                     <div class="text-center logobox @if($settings->logo == null) d-none @endif">
                        <img id="preview_logo" src="@if($settings->logo != null){{ asset('images/main/'.$settings->logo) }}@endif" width="150">
                     </div>
                     @endif
                     <div class="form-group">
                        <label for="logo">{{__('Logo :')}} <span class="fsgred">*</span></label>
                        <input type="file" name="logo" id="logo" class="form-control" required>
                        <small>{{__('You can upload any size but the size we recommend')}} (110x32)</small>
                     </div>
                  </div>
                  <div class="image bg-black text-white">
                     @if($settings != null)
                     ...
                     <div class="form-group">
                        ...
                        <small>{{__('Recommend')}} (60x60)</small>
                     </div>
                  </div>
