               ...
               <div class="modal-body">
                  ...
                  <form id="addAdminForm" method="POST">
                     ...
                     <div class="form-group">
                        ...
                        <select name="permission" id="permission" class="form-select fm40">
               ...
               <tr>
                  ...
                  <td class="text-center">
                     ...
                     <a href="#" data-id="{{ $user->id }}" id="banuser" class="banuser{{ $user->id }} btn btn-danger btn-sm @if($user->status == 2) d-none @endif">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon m-0" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><circle cx="12" cy="12" r="9" /><line x1="5.7" y1="5.7" x2="18.3" y2="18.3" /></svg>
                     </a>
