...
class SettingsController extends Controller
{
    ...
    public function UpdateInfo(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'waiting_time' => ['required', 'string', 'max:50'],
            'color_1' => ['required'],
            'color_2' => ['required'],
            'color_3' => ['required'],
        ]);
        ...
        // Check waiting time
        if ($request->waiting_time > 50 or $request->waiting_time < 1) {
            // Error response
            return response()->json([
                'error' => ['waiting time must be less than 50 and more than 1'],
            ]);
        }
        ...
        $updateSettings = Setting::where('id', 1)->update([
            ...
            'addthis_code' => $request['addthis_code'],
            'disqus_url' => $request['disqus_url'],
